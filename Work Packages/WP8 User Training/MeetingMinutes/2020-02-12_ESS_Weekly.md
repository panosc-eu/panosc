...
- [ ] Mads: Communicate event dates for WP5 meeting in Hamburg to Peter and Erik(DTU) (indication: Late march/early april)
...
- [ ] Alexandre: Once Peter has tested the new site thoroughly, will migrate MediaWiki content from ucph wiki to the new system.
- [ ] Alexandre: In march, check with Jesper about ESS-run PaNOSC-mailinglist(s)
