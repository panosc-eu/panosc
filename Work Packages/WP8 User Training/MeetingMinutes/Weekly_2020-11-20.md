...
======
1. Tasks
1. Public slides from LENS meeting
1. LENS - LEAPS collaboration. Feedback from LENS GA
1. Tasks related to requirement gathering, see  ![mind map](https://github.com/panosc-eu/panosc/blob/master/Work%20Packages/WP8%20User%20Training/MeetingMinutes/snippets/Requirements.pdf)
1. Technical updates
1. AoB
...
1. Tasks
--------
- [ ] Review tasks on ![mind map]. Teodor reviewed design with moodle and edx and have discussed with Peter

- [ ] Thibaud & Nazaré. Collect training material from ExPaNDS partners. Still working on that, may get new material from upcoming meetings (e.g. LEAPS)

- [ ] Thibaud:
https://www.youtube.com/watch?v=g5_DdVzWiQs&feature=youtu.be
https://www.fun-mooc.fr/courses/course-v1:ParisSaclay+71002+session01/about

2. Public slides from PaNOSC/ExPaNDS meeting
--------------------------------------------
Agreed to shares slides as is, including the one with zoom photo since nobody objected. 


3. LENS - LEAPS collaboration. Feedback from LENS GA
----------------------------------------------------



4. Tasks related to requirement gathering
-----------------------------------------
Vincent to be added 
...
* Guiseppe: Meeting today on how to register services in EOSC
